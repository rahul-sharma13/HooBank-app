  ...
  return (
    <section ref={ref} className={layout.section}>
      <div className={layout.sectionInfo}>
        <motion.h2 animate={sectionInfoHeadingCtrl}
        {...animationProps} className={styles.heading2} >
      ...
      <div className={layout.sectionImg} >
        <motion.img animate={imageCtrl} {...animationProps} src={card} alt="card" className="w-[100%] h-[100%]"/>
      </div>
    </section>
  )
  }
